...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        network1.addRelationship(programmer3, programmer4, "Colleagues");
        network1.addRelationship(programmer1, designer2, "Friends");
        network1.addRelationship(designer3, person1, "Brothers");
        network1.addRelationship(programmer4, programmer5, "Colleagues");
        network1.addRelationship(designer2, programmer3, "Friends");
        network1.addRelationship(programmer1, company1, "Employee");
        network1.addRelationship(programmer3, company2, "CEO");
        network1.addRelationship(designer1, company3, "Employee");

        network1.nodeImportance(programmer1);
