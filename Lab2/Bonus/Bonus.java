...
public class Bonus {
    public static void main(String[] args) {
        ...
        Road road1 = new Road(new Highway("concrete", 4), 120.0f, Iasi, Brasov, 400);
        Road road2 = new Road(new Highway("cement", 4), 120.0f, Brasov, Cluj, 300);
        Road road3 = new Road(new Express("concrete", 7), 90.0f, Sibiu, Cluj, 100);
        Road road4 = new Road(new Highway("cement", 4), 120.0f, Iasi, Bucuresti, 500);  
        Road road5 = new Road(new Highway("concrete", 4), 120.0f, NewYork, LosAngeles, 1000);
        Road road6 = new Road(new Country("stone", 2), 70.0f, Iasi, Petrom, 20);
        Road road7 = new Road(new Express("cement", 10), 90.0f, Chicago, ChicagoMidway, 120);
        Road road8 = new Road(new Express("concrete", 7), 90.0f, Bucuresti, Otopeni, 10);
        ...
        Solution solution = new Solution(connection1);
        solution.dijkstraLength(Sibiu, Iasi);
        solution.dijkstraSpeed(Iasi, Cluj);
